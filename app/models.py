...
class AppSettings(db.Model):
    ...
    plant_of_the_day_slack_enabled: Mapped[bool] = mapped_column(nullable=False, default=True)
    ...
    def to_dict(self):
        return {
            ...
            "plant_of_the_day_slack_enabled": self.plant_of_the_day_slack_enabled,
